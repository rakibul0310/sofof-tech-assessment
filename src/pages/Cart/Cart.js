...
const Cart = () => {
  const [cartItems, setCartItems] = useState([
    {
      id: 1,
      name: "خدمة مساعدة الحج",
      nameEn: "Hajj Assistance Service",
      price: 150,
      quantity: 1,
      image: "/placeholder.svg?height=80&width=80",
      description: "خدمة شاملة لمساعدة الحجاج",
    },
    {
      id: 2,
      name: "دليل المساجد",
      ...
      quantity: 2,
      image: "/placeholder.svg?height=80&width=80",
      description: "دليل شامل لمساجد مكة المكرمة",
    },
    {
      id: 3,
      name: "خدمة الإطعام",
      ...
      quantity: 1,
      image: "/placeholder.svg?height=80&width=80",
      description: "خدمة إطعام الحجاج والمعتمرين",
    },
  ]);
        ...
        <>
          ...
          <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl p-6 text-white">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex justify-between items-center">
                <span>الضريبة</span>
                <span>{Math.round(totalAmount * 0.15)} ر.س</span>
              </div>
              <div className="border-t border-purple-400 pt-3">
                <div className="flex justify-between items-center font-bold text-lg">
                  <span>المجموع الكلي</span>
                  <span>{Math.round(totalAmount * 1.15)} ر.س</span>
                </div>
              </div>
            </div>
